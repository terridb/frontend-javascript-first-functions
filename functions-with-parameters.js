...
const personalGreeting = greeter("Kees");
...
function merge(stringOne, stringTwo) {
  return stringOne + stringTwo;
}

const sentence = merge("abra", "cadabra");
...
const dogYears = calculateDogYears(2);
